...
const SessionTabModal = props => {
  ...
  const associatedGoal = props.goals.find(goal => {
    return goal._id === props.selectedSession.goalId
  })
  ...
  const resourcesArr = props.selectedSession.resources.filter(resource => {
    return resource.show === true
  })
  ...
  return (
    <Modal show={props.show}>
        ...
        <Tabs defaultActiveKey={1} animation={true} id="studySessionDetails">
          <Tab eventKey={1} title="Study Session">
            <div>
              ...
              {associatedGoal ? (
                <span>
                  <p>
                    <b>Goal Category:</b> {associatedGoal.category}
                  </p>
                  <p>
                    <b>Associated Goal:</b> {associatedGoal.goal}
                  </p>
                </span>
              ) : null}
              <p>
                <b>Study Session Topics:</b> {props.selectedSession.title}
              </p>
              <p>
                <b>Start Date and Time:</b> {props.selectedSession.start}
              </p>
              <p>
                <b>End Date and Time:</b> {props.selectedSession.end}
              </p>
              <p>
                <b>Location:</b> {props.selectedSession.location}
              </p>
            </div>
          </Tab>
            ...
            <div>
              ...
              <form>
                <FormGroup>
                  ...
                  <FormControl.Static>
                    Add the name, URL, and/or description for resources you want
                    to be sure to cover during this study session.
                  </FormControl.Static>
                </FormGroup>
                ...
                <Button
                  ...
                  onClick={props.handleResourceSubmit}
                >
                  Add New Resource
                </Button>
              ...
              <div>
                <b>
                  <h4 className="centerHeader">Saved Resources</h4>
                </b>
          ...
          <Tab eventKey={3} title="Study Buddies">
            ...
            <p className="comingSoonNote">
              <b>Coming Soon!</b> Invite your friends and form group study
              sessions!
            </p>
      ...
      <Modal.Footer>
        ...
        <Button className="sessionDetailBtn" onClick={props.hideSessionDetails}>
          Close
        </Button>
